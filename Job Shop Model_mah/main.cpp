...
int main(int argc, char* argv[]) {
    ...
    if (traffic_intensity <= 0 || traffic_intensity >= 1) {
        cerr << "Traffic intensity must be between 0 and 1" << endl;
        return 1;
    }
    ...
    // Generate reports
    string report_ws1 = "report_1_" + to_string(traffic_intensity) + ".out";
    string report_ws2 = "report_2_" + to_string(traffic_intensity) + ".out";
